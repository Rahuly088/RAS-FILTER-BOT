...
API_ID = int(environ.get('API_ID', '25848267'))
API_HASH = environ.get('API_HASH', '88cf2c17c7a2bd21f4345c89c648dd40')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002082507673'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002081769234').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# auth_channel means force subscribe channel.
auth_channel = environ.get('AUTH_CHANNEL', '-1001923674324') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://skyyadav56183549:EBLbug6XE8zj9xgL@cluster0.0fdkzri.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
